    ...
    <>
      <div>
        <section className="section">
          ...
          <div className="section-01-p-2">
            應該會有一段很短的適應期，因為React的寫法很奇葩，它把
            html和Javascript寫在同一個檔案裡面，非常方便。
          </div>
          <div className="section-01-p-4">完全 0 基礎者：</div>
          <div className="section-01-p-2">
            課程內容設計上只會教
            我們常用的、會用的基本觀念，太深入的程式語言需要很大量的時間，為了避免大家一次大量的學習會消化不良，因此挑選很好用的，而且比較好理解的程式碼和小工具輔助大家完成網頁作品，希望大家勇敢、持續的往前發展。
          </div>
          <div className="section-01-p-5">不是科班出生？ 沒有關係。</div>
          <div className="section-01-p-5">
            只是想做一些小工具？ 太好了！這裡很適合你！
          </div>
          <div className="section-01-p-5">
            以前學過，但是忘記了？ 我們很快就能幫你找回來。
          </div>
          <div className="section-01-p-3">重要的是：</div>
          <div className="section-01-p-3">幫自己訂一個目標！</div>
        </section>
        ...
        <section className="section">
          <div className="section-03-p-1">學完了之後......</div>
          <div className="section-03-p-2">
            靜態的、可發布消息的、不用擔心資料庫費用的
          </div>
          <div className="section-03-p-2">靜態網站就可以自由設計啦！</div>
        </section>
      </div>
    </>
  );
